...
INSERT INTO envios (fecha_envio, fecha_entrega, codigo_producto)
VALUES ('2022-02-10 10:15:00', '2022-02-15 14:45:00', 'XYZ789');
INSERT INTO envios (fecha_envio, fecha_entrega, codigo_producto)
VALUES ('2022-03-05 09:30:00', '2022-03-10 13:20:00', 'PQR456');
INSERT INTO envios (fecha_envio, fecha_entrega, codigo_producto)
VALUES ('2022-04-20 11:45:00', '2022-04-25 15:10:00', 'LMN001');
INSERT INTO envios (fecha_envio, fecha_entrega, codigo_producto)
VALUES ('2022-05-12 07:55:00', '2022-05-17 10:25:00', 'DEF77');
INSERT INTO envios (fecha_envio, fecha_entrega, codigo_producto)
VALUES ('2022-06-08 08:20:00', '2022-06-13 12:40:00', 'GHI888');
INSERT INTO envios (fecha_envio, fecha_entrega, codigo_producto)
VALUES ('2022-07-03 10:05:00', '2022-07-08 14:15:00', 'JKL999');
...
SELECT ADDDATE((SELECT envios.fecha_entrega FROM envios WHERE codigo_producto = 'ABC123'), 05);
...
SELECT ADDTIME((SELECT envios.fecha_envio FROM envios WHERE codigo_producto = 'XYZ789'), '0 :04:30:00');
...
SELECT CONVERT_TZ(fecha_envio, 'UTC', 'GMT-3')
AS fecha_convertida FROM envios WHERE codigo_producto = 'PQR456' LIMIT 1;
...
SELECT DATEDIFF (CURDATE(), envios.fecha_entrega) FROM envios WHERE codigo_producto = 'DEF77';
...
SELECT DATE_FORMAT(fecha_envio, '%D %M %Y') FROM envios;

/* -- Utiliza la función DATE_SUB para calcular la fecha de envío del envío con ID 4 si se le restan 2 días.*/

SELECT DATE_SUB(fecha_envio, INTERVAL 1 DAY) FROM envios WHERE id = 2; 
...
SELECT DAYNAME(fecha_entrega) FROM envios WHERE id = 2; 

/*-- Utiliza la función DAYOFMONTH para obtener el día del mes en que se entregará el envío con código de producto 'GHI888'.*/
SELECT DAYOFMONTH(fecha_envio) FROM envios WHERE codigo_producto = 'GHI888';
